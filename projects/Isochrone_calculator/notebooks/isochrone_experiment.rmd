...
# Starting Point 
# https://maps.app.goo.gl/p2SqWT23DZ66zDmX6
lat <- 19.398085101174537
lon <- -99.1560335457441

# Maximum duration of trajectories in seconds 
T_segs <- 10*60 

VEL_MPS <- 1.4 # Average velocity in metter per second

TWT_IND <- TRUE # Indicator if there are waiting times 
TRAFFIC_WT <- 80 # Witing time in seconds 
